...
public class Tfdif extends UniversalActor  {
	public static void main(String args[]) {
		...
		Tfdif instance = (Tfdif)new Tfdif(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Tfdif(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Tfdif.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Tfdif(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Tfdif.getReferenceByLocation(new UAL(ual)); }
	public Tfdif(boolean o, UAN __uan)	{ super(false,__uan); }
	public Tfdif(boolean o, UAL __ual)	{ super(false,__ual); }
	public Tfdif(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Tfdif(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Tfdif(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Tfdif()		{  }
	public Tfdif(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "Tfdif", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Tfdif)actorReference).setUAL(getUAL());
			((Tfdif)actorReference).setUAN(getUAN());
			self = new Tfdif(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public double tf(int termFreq) {
			if (termFreq>0) {			return 1+(Math.log10(termFreq));
}			else {{
				return 0;
			}
}		}
		...
		public void main(String[] args) {
			...
			Document d = ((Document)new Document(this).construct(file));
			HashMap newMap = d.wordFrequency();
			newMap.put((String)"simplyTorch", 3);
