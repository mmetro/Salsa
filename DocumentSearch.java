...
public class DocumentSearch extends UniversalActor  {
	public static void main(String args[]) {
		...
		DocumentSearch instance = (DocumentSearch)new DocumentSearch(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new DocumentSearch(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return DocumentSearch.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new DocumentSearch(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return DocumentSearch.getReferenceByLocation(new UAL(ual)); }
	public DocumentSearch(boolean o, UAN __uan)	{ super(false,__uan); }
	public DocumentSearch(boolean o, UAL __ual)	{ super(false,__ual); }
	public DocumentSearch(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public DocumentSearch(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public DocumentSearch(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public DocumentSearch()		{  }
	public DocumentSearch(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "search.DocumentSearch", sourceRef);
			  }
	...
	public UniversalActor construct (int len) {
		Object[] __arguments = { new Integer(len) };
	...
	public class State extends UniversalActor .State {
		public DocumentSearch self;
		public void updateSelf(ActorReference actorReference) {
			((DocumentSearch)actorReference).setUAL(getUAL());
			((DocumentSearch)actorReference).setUAN(getUAN());
			self = new DocumentSearch(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "search.DocumentSearch$State" );
		...
		public void construct(int len){
			docArray = new Document[len];
		}
		public void storeDocMap(Document doc, int i) {
			docArray[i] = doc;
		}
		public Document getDocMap(int i) {
			return docArray[i];
		}
	}
}