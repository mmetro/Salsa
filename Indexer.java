...
public class Indexer extends UniversalActor  {
	public static void main(String args[]) {
		...
		Indexer instance = (Indexer)new Indexer(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Indexer(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Indexer.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Indexer(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Indexer.getReferenceByLocation(new UAL(ual)); }
	public Indexer(boolean o, UAN __uan)	{ super(false,__uan); }
	public Indexer(boolean o, UAL __ual)	{ super(false,__ual); }
	public Indexer(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Indexer(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Indexer(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Indexer()		{  }
	public Indexer(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "search.Indexer", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Indexer)actorReference).setUAL(getUAL());
			((Indexer)actorReference).setUAN(getUAN());
			self = new Indexer(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "search.Indexer$State" );
		...
		public void iterateHashmap(HashMap mp) {
			...
			while (it.hasNext()) {
				Map.Entry pairs = (Map.Entry)it.next();
				{
					...
					{
						Object _arguments[] = { pairs.getKey()+" = "+pairs.getValue() };
		...
		public void act(String[] args) {
			Tfdif t = ((Tfdif)new Tfdif(this).construct());
			{
				...
				DocumentSearch ds = ((DocumentSearch)new DocumentSearch(this).construct(files.length));
				for (int i = 0; i<files.length; i++){
					Document d = ((Document)new Document(this).construct(files[i]));
					{
						...
						{
							Object _arguments[] = {  };
							Message message = new Message( self, d, "wordFrequency", _arguments, null, token_4_0 );
							__messages.add( message );
						}
						// ds<-storeDocMap(d, i)
						{
							Object _arguments[] = { d, i };
							Message message = new Message( self, ds, "storeDocMap", _arguments, token_4_0, token_4_1 );
							__messages.add( message );
						}
						// d<-getMap()
						{
							Object _arguments[] = {  };
							Message message = new Message( self, d, "getMap", _arguments, token_4_1, token_4_2 );
							__messages.add( message );
						}
						// d<-makeTreeMap(token)
						{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, t, "getMap", _arguments, token_2_0, token_2_1 );
					__messages.add( message );
				}
				// hashMapSize(token)
				{
					Object _arguments[] = { token_2_1 };
					Message message = new Message( self, self, "hashMapSize", _arguments, token_2_1, token_2_2 );
					__messages.add( message );
				}
				// strintcat("Final size: ", token)
				{
					Object _arguments[] = { "Final size: ", token_2_2 };
					Message message = new Message( self, self, "strintcat", _arguments, token_2_2, token_2_3 );
					__messages.add( message );
				}
