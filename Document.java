...
public class Document extends UniversalActor  {
	public static void main(String args[]) {
		...
		Document instance = (Document)new Document(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Document(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Document.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Document(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Document.getReferenceByLocation(new UAL(ual)); }
	public Document(boolean o, UAN __uan)	{ super(false,__uan); }
	public Document(boolean o, UAL __ual)	{ super(false,__ual); }
	public Document(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Document(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Document(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Document()		{  }
	public Document(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "search.Document", sourceRef);
			  }
	...
	public UniversalActor construct (File file) {
		Object[] __arguments = { file };
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Document)actorReference).setUAL(getUAL());
			((Document)actorReference).setUAN(getUAN());
			self = new Document(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "search.Document$State" );
		...
		public void construct(File file){
			...
			map = new HashMap();
			...
			catch (Exception e) {
				{
					...
					{
						Object _arguments[] = { "Could not open\n" };
